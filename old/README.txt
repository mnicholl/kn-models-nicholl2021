...
NOTE:
Data in this 'old' directory extended the Piro & Kollmeier (2018) formalism for the shock heating until (potentially) unphysically late times. The newer data in the parent directory are preferred. User beware!
